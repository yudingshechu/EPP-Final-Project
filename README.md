...
- The percentage of the increase in sex ratios due to one-child policy (POCP) for the
  Han Chinese is:
...
| -------------------------- | --------------------- | -------------------------- | --------------------- | ---------------------- |
| Born between 1979 and 1984 | $E(S_i\|H=1,T=0,K=1)$ | $E(S_i\|H=0,T=0,K=1)$      | $E(S_i\|H=1,T=0,K=0)$ | $E(S_i\|H=0,T=0,K=0)$  |
| Born after 1984            | $E(S_i\|H=1,T=1,K=1)$ | $E(S_i\|H=0,T=1,K=1)$      | $E(S_i\|H=1,T=1,K=0)$ | $E(S_i\|H=0,T=1,K=0)$  |
